        ...
        <List id={SlotID.CustomModel}>
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            accessStore.update(
                              (access) =>
                                (access.openaiUrl = 'http://localhost:1234' /* e.currentTarget.value */),
                            )
                          }
                        ></input>
                      </ListItem>
                      ...
                      >
                        <PasswordInput
                          ...
                          onChange={(e) => {
                            accessStore.update(
                              (access) =>
                                (access.openaiApiKey = "lm-studio" /* e.currentTarget.value */),
                            );
                          }}
                        />
                      </ListItem>
          ...
          >
            <input
              ...
              onChange={(e) =>
                config.update(
                  (config) => (config.customModels = 'model-identifier' /* e.currentTarget.value */),
                )
              }
            ></input>
          </ListItem>
